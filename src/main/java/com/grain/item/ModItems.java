...
import com.grain.item.custom.ModSwiftnessBoots;
...
public class ModItems {
    ...
    public static final Item SWIFTNESS_BOOTS = registerItem("swiftness_boots", new ModSwiftnessBoots(ModArmorMaterials.SWIFTNESS, ArmorItem.Type.BOOTS, new FabricItemSettings()));
